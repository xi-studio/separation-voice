...
class VAENet(nn.Module):
    def __init__(self, in_size=2, out_size=2):
        ...
        self.encoder = UNet(in_channels=in_size, out_channels=64)
        self.decoder = UNet(in_channels=20, out_channels=20)

        self.down1 = nn.Sequential(
            UNetDown(64, 64, normalize=False),
            UNetDown(64, 20, normalize=False)
        )
